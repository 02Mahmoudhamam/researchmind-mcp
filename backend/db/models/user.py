...
Identity and ownership only. Authentication — credentials, hashing, tokens —
is Milestone M2 and is deliberately absent: a schema that already carries a
password column implies a decision M2 has not made yet.
"""

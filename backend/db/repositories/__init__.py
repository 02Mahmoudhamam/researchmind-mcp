...
Explicit repositories, none of them inheriting a generic CRUD base. The
...
`DocumentRepository`, `DocumentChunkRepository` and `DocumentPageRepository`
require `user_id` on every method that can reach a row, and put it in the SQL.
...
from backend.db.repositories.document_page import DocumentPageRepository

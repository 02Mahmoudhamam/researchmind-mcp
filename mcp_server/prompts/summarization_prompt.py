...
schema = Prompt(
    ...
    arguments=[
        PromptArgument(name="document_id", description="Target document ID", required=True),
        PromptArgument(name="depth", description="Summary depth: brief|detailed", required=False),
    ],
)
